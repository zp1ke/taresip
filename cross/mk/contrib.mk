...
EXTRA_I386 := \
    ...
    EXTRA_LFLAGS='-miphoneos-version-min=7.0 -arch i386 -L$(CONTRIB_FAT)/lib \
        -isysroot $(SDK_SIM)'
...
EXTRA_X86_64 := \
    ...
    OBJCFLAGS='-fobjc-abi-version=2 -fobjc-legacy-dispatch' \
    EXTRA_LFLAGS='-miphoneos-version-min=7.0 -arch x86_64 -L$(CONTRIB_FAT)/lib \
        -isysroot $(SDK_SIM)'
...
$(BUILD_AARCH64) $(BUILD_ARMV7) $(BUILD_I386) $(BUILD_X86_64) $(BUILD_FAT):
	@mkdir -p $@
